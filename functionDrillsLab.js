...
const compareNums = (num1, num2) =>{
  num1 > num2 ? console.log(num1 + ' is bigger.'):
  num1 < num2 ? console.log(num2 + ' is bigger.'):
  console.log(num1)
}
compareNums(7, 5)
...
const faveColorFinder = (color) =>{
  color === 'red' ? console.log('red is a great color'):
  color === 'green' ? console.log('green is a solid favorite color'):
...
function thatsOdd(num7){
  num7 % 2 === 0 ? console.log("That's not odd!"):
...
let myBestMovie = bestMovie("The Four Feathers")
...
const allUpper = function(toYell){
  return toYell.toUpperCase()
}
...
myEmail = "        Hello Friend, I have questions about JS. Friend."
...
const goldToFrogs = gold => Math.floor(gold / 3)

let totalFrogs = goldToFrogs(994673)
...
//I did it the correct way originally.

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,8,9]
let sampArr2 = [1,2,3,4,5,6,7,8,9]
/*
...
let arrayInAscending = arrayOfAscension(sampleArray)

console.log(arrayOfAscension(sampArr2))
console.log(arrayInAscending)
